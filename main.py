...
#Instanciar o módulo Flask na nossa variavel app
app = Flask('carros')

# PRIMEIRO METODO - VISUALIZAR OS DADOS (GET)
# app.route -> definir que essa funcao e uma rota para que o flask entenda que isso e um metodo a ser executado
@app.route('/carros', methods =['GET'])
def get_carros():
    return Carros


#PRIMEIRO METODO PT 2 - VISUALIZAR DADOS POR ID (GET)
